...
import { RoomParts, RoomParts_users } from "../../__generated/RoomParts";
...
export default function RoomItem({ users, unreadTotal, id }: RoomParts) {
  const { data: meData } = useMe();
  const navigation = useNavigation<NavigationProp<{Room: {id: number, talkingTo?: RoomParts_users | null}}>>();
