...
const loadTodosReducer = handleAction(LOAD_TODOS, (state, action) => {
  return { ...state, todos: action.payload }
}, initState)

const updateCurrentReducer = handleAction(UPDATE_CURRENT, (state, action) => {
  return { ...state, currentTodo: action.payload }
}, initState)

const replaceTodoReducer = handleAction(REPLACE_TODO, (state, action) => {
  return { 
    ...state, 
