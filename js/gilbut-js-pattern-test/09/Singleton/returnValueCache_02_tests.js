// simpleCache를 쓴 returnValueCache의 단위 테스트 확장본
...
describe('returnValueCache', function () {
  ...
  // 테스트 객체를 생성하는 도우미 함수. testFunstion에 스파이를 심고 반환 객체의 spyReference 프로퍼티에 스파이 참조값을 담아둔다.
  function createATestObject() {
    ...
    // 애스팩트가 적용된 이후에는 스파이를 직접 참조할 수 없으므로 현재 참조값을 보관해둔다.
