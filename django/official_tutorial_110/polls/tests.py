...
class QuestionMethodTests(TestCase):
  ...
  def test_was_published_recently_with_future_question(self):
    """
    was_published_recently() should return False for questions whose pub_date is in in the future.
    """
...
def create_question(question_text, days):
  """
  Creates a question with the givne `question_text` and published the given number of `days` offset to now
