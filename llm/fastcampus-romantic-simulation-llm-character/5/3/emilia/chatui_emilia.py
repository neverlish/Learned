...
class CustomUI(QWidget):
    def __init__(self):
        ...
        self.GIF_PATHS = ["emilia1.png", "emilia2.png", "emilia3.png", "emilia4.png"]
        self.image_index = 0
    ...
    def display_typing_effect(self, message):
        self.typing_thread = TypingEffect(message)
        self.typing_thread.update_text.connect(self.chat_area.setText)
        self.typing_thread.start()
    ...
    def on_enter_pressed(self):
        ...
        if user_input:
            ...
            response_ko = self.request_gpt_response(user_input)
            if response_ko:
                # Send Korean GPT response to TTS API
                audio_path = self.request_tts(response_ko)
                ...
                self.display_typing_effect(response_ko)
